...
void Pipeline::createElements() {
    ...
    * on the source of the frames. */
    ...
    fpsdisplay = gst_element_factory_make("fpsdisplaysink", "fps-display");
}
...
void Pipeline::Verify() {
    ...
    if (!pgie || !nvtracker || !tiler || !nvvidconv || !nvosd || !sink || !fpsdisplay) {
...
/* Set necessary properties of the tracker element. */
    ...
    /*Set necesary properties for fps display. */
    g_object_set(G_OBJECT(fpsdisplay), "text-overlay", FALSE, "video-sink", sink, "sync", FALSE, NULL);
